...
from trl.trainer.sft_trainer import (Any, AutoProcessor, Callable, DataCollator, DataCollatorForLanguageModeling, DataCollatorForVisionLanguageModeling, Dataset, EvalPrediction, F, FLASH_ATTENTION_VARIANTS, IterableDataset, Path, PeftConfig, PeftModel, PreTrainedModel, PreTrainedTokenizerBase, ProcessorMixin, SFTConfig, SFTTrainer, TrainerCallback, TrainingArguments, Version, _BaseTrainer, _CHUNKED_LM_HEAD_CHUNK_SIZE, _chunk, _patch_chunked_ce_lm_head, accelerate, apply_chat_template, clone_chat_template, contextlib, create_model_from_path, dataclass, defaultdict, dft_loss, get_act_offloading_ctx_manager, get_config_model_id, get_peft_model, get_training_chat_template, is_conversational, is_peft_available, is_peft_model, logger, nn, os, pack_dataset, pad, prepare_multimodal_messages, selective_log_softmax, torch, transformers, types, warnings, Any, AutoProcessor, Callable, DataCollator, DataCollatorForLanguageModeling, DataCollatorForVisionLanguageModeling, Dataset, EvalPrediction, F, FLASH_ATTENTION_VARIANTS, IterableDataset, PeftConfig, PeftModel, PreTrainedModel, PreTrainedTokenizerBase, ProcessorMixin, SFTConfig, SFTTrainer, TrainerCallback, TrainingArguments, Version, accelerate, clone_chat_template, contextlib, create_model_from_path, defaultdict, dft_loss, get_act_offloading_ctx_manager, get_config_model_id, get_peft_model, get_training_chat_template, is_conversational, is_peft_available, is_peft_model, logger, nn, os, pad, torch, transformers, Callable, DataCollator, DataCollatorForLanguageModeling, Dataset, F, IterableDataset, apply_chat_template, is_conversational, os, pack_dataset, pad, transformers, warnings, F, PeftModel, PreTrainedModel, is_peft_available, logger, os, torch, F, os)
